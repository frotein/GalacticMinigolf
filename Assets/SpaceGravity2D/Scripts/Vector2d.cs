...
namespace UnityEngine {
	...
	public struct Vector2d {
		...
		/// found at https://github.com/sldsmkd/vector3d
		/// 
		...
		public static explicit operator Vector3(Vector2d vector2d) {
			return new Vector3((float)vector2d.x, (float)vector2d.y);
		}
